...
namespace game_framework {
	...
	void Zombie::OnShow2() {
		...
		//進度條切換，中間顯示最後一波
		if (zombie[6].IsAnimationDone() && zombie[21].IsAnimationDone() && zombie[23].IsAnimationDone() && zombie[7].IsAnimationDone() && zombie[8].IsAnimationDone() && zombie[29].IsAnimationDone())
		{
			count_last_wave += 1;
